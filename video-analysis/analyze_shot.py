...
# Load video
video_path = "better_ideal_shot.mp4"
        ...
        if ball_pos is not None and results.pose_landmarks:
            ...
            if all(landmarks[i].visibility > 0.7 for i in required_landmarks):
               ...
               # Collect and save metrics if before or at contact
                ...
                cv2.putText(frame_bgr, f"Frame: {n}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
                ...
                print(f"Frame {n}, Error: Keypoints not visible")
        else:
            print(f"Frame {n}, Error: No ball or keypoints detected")
